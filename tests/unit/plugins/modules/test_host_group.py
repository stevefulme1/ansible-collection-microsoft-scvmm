...
"""Unit tests for scvmm_host_group module documentation stub."""
...
class TestArgumentSpec:
    ...
    def test_parent_option(self, parsed_doc):
        opts = parsed_doc.get("options", {})
        assert "parent" in opts
        assert opts["parent"]["default"] == "All Hosts"
...
class TestReturn:
    ...
    def test_return_has_host_group_key(self, module_docs):
        _doc, _examples, returns = module_docs
        parsed = yaml.safe_load(returns)
        assert "host_group" in parsed
