...
"""Unit tests for scvmm_storage_classification module documentation stub."""
...
class TestReturn:
    ...
    def test_return_has_storage_classification_key(self, module_docs):
        _doc, _examples, returns = module_docs
        parsed = yaml.safe_load(returns)
        assert "storage_classification" in parsed
